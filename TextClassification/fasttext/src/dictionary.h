...
extern const std::string dict_path;
extern const std::string user_dict_path;
...
class Dictionary {
 ...
 public:
  ...
  void deletePunc(std::vector<std::string>&) const;
  void getChineseWord(std::vector<std::string>&) const;
  bool isHanzi(const std::string&) const;
  ...
  int32_t getLine(std::istream&, std::vector<int32_t>&, std::vector<int32_t>&)
      const;
  int32_t getChLine(std::istream&, std::vector<int32_t>&, std::vector<int32_t>&)
      const;
  int32_t getLine(std::istream&, std::vector<int32_t>&, std::minstd_rand&)
      const;
  int32_t getChLine(std::istream&, std::vector<int32_t>&, std::minstd_rand&)
      const;
